...
function getUsersFromDatabase(array) {
  ...
  return console.log(Array.from(array));
...
function removeLastElement(arr) {
  ...
  arr.length === 0 ? console.log("undefined") : arr.pop();
...
function createArray(...elements) {
  ...
  X = elements.length === 0 ? [] : Array.of(...elements);
...
function getElementAtIndex(arr, index) {
  ...
  } else x = "index out of range, undefined";
...
function copyAndSwapElements(arr, target, start, end) {
  ...
  if (
    ...
    // якщо ні, виводимо рядок "Неприпустимі індекси"
...
function customIncludes(arr, element) {
  ...
  console.log(`Елемент зустрічається ${occurrences} разів в масиві.`);
